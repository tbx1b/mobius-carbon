...
#include <hali86pc/physmem.h>
#include <hali86pc/phys_lmm.h>


void phys_lmm_add(__uintptr_t min_pa, __size_t size)
{
	__uintptr_t max_pa = min_pa + size;
	__uintptr_t min_va = phystokv(min_pa);
	__uintptr_t max_va = phystokv(max_pa);
