 ...
 */
	...
	for (i = 0; i < sizeof(id->cache_config); i++)
	{
		...
		case 0:
			break;
		case 0x01:
			s = "Instruction TLB: 4K-byte pages, "
				"4-way set associative, 64 entries";
			break;
		case 0x02:
			s = "Instruction TLB: 4M-byte pages, "
				"fully associative, 2 entries";
			break;
		case 0x03:
			s = "Data TLB: 4K-byte pages, "
				"4-way set associative, 64 entries";
			break;
		case 0x04:
			s = "Data TLB: 4M-byte pages, "
				"4-way set associative, 8 entries";
			break;
		case 0x06:
			s = "Instruction cache: 8K bytes, "
				"4-way set associative, 32 byte line size";
			break;
		case 0x08:
			s = "Instruction cache: 16K bytes, "
				"4-way set associative, 32 byte line size";
			break;
		case 0x0a:
			s = "Data cache: 8K bytes, "
				"2-way set associative, 32 byte line size";
			break;
		case 0x0c:
			s = "Data cache: 16K bytes, "
				"2-way set associative, 32 byte line size";
			break;
		case 0x40:
			s = "No L2 cache";
			break;
		case 0x41:
			s = "Unified cache: 128K bytes, "
				"4-way set associative, 32 byte line size";
			break;
		case 0x42:
			s = "Unified cache: 256K bytes, "
				"4-way set associative, 32 byte line size";
			break;
		case 0x43:
			s = "Unified cache: 512K bytes, "
				"4-way set associative, 32 byte line size";
			break;
		case 0x44:
			s = "Unified cache: 1024K bytes, "
				"4-way set associative, 32 byte line size";
			break;
		case 0x45:
			s = "Unified cache: 2048K bytes, "
				"4-way set associative, 32 byte line size";
			break;
		case 0x82:
			s = "Unified cache: 256K bytes, "
